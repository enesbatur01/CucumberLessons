...
Feature: US008 DataTables Testi
  ...
  Scenario Outline: TC01 DataTables Veri Girisi
    Given kullanici "editorDataTablesUrl" sayfasina gider
    When sayfadaki new butonuna basar
    And verilen bilgileri girer "<name>", "<lastname>", "<position>", "<office>", "<extension>", "<date>", "<salary>"
    And create butonuna basar
    And kullanici search bolumune "<name>" bilgisiniz girer
